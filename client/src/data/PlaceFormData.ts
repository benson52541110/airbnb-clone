...
export const roomCategoryList: ListItem[] = [
	...
	{ name: "money", icon: "money", text: "奢華" },
	{ name: "wind-turbine", icon: "wind-turbine", text: "風車" },
	{ name: "beach", icon: "beach", text: "海灘" },
	{ name: "apps-box", icon: "apps-box", text: "大型" },
	{ name: "campfire", icon: "campfire", text: "露營" },
	{ name: "piano", icon: "piano", text: "鋼琴" },
	{ name: "city", icon: "city", text: "城市" },
	{ name: "cook", icon: "cook", text: "廚師" },
	{ name: "home-variant", icon: "home-variant", text: "木屋" },
	{ name: "pool", icon: "pool", text: "泳池" },
	{ name: "baseball-bat", icon: "baseball-bat", text: "娛樂" },
	{ name: "snowflake", icon: "snowflake", text: "雪景" },
	{ name: "temple", icon: "temple", text: "寺廟" },
